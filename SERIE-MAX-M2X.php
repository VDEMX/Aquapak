...
<?php include("includes/head.php"); ?>
 ...
 <section id="container">
 	...
 	<div class="cien">
 	<h2 class="headline">Serie MAX M2X</h2>
 	</div>
 		<h2>Curvas de rendimiento</h2>
 		<img src="images/max2x-curvas.gif" alt="Curvas">
 		<p class="m1em"><strong class="m1em">SERIE M2X</strong> <span class="m1em">2 lps / 120 lpm / 31 gpm</span> <span class="azul-aqua">Rango de flujo: 35 a 130 lpm</span> <span class="m1em">0.58 a 2.1 lps</span></p>
 		<img src="images/max2x.gif" alt="Dimensiones" class="mb1em">
